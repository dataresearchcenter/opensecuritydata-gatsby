...
const getUrl = (key, wid) =>
  `https://spreadsheets.google.com/feeds/list/${key}/${wid}/public/values?alt=json`

const loadSpreadsheet = (key, sheet, callback) => {
...
export default loadSpreadsheet
